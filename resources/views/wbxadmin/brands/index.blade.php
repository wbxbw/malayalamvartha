            ...
            <tr>
              ...
              <td>
                <div class="d-flex align-items-center">
                  <a href="{{ route('brands.edit',Crypt::encrypt($brand['id']))}}" class="text-reset">{{ $brand['name'] }}</a>
                </div>
              </td>
                <td>
                    <img
                        src="{{ url('wx.images/brands/'.$brand['image']) }}"
                ...
                <td>
                    <div class="dropdown">
                      ...
                      <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="customer-context-menu-0">
                        <li>
                          <a class="dropdown-item" href="{{ route('brands.edit',Crypt::encrypt($brand['id']))}}">Edit</a>
                        </li>
                        <li>
