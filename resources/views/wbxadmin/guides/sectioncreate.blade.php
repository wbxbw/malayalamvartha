...
<div id="top" class="sa-app__body">
  <div class="mx-sm-2 px-2 px-sm-3 px-xxl-4 pb-6">
    <div class="container">
      ...
      <form action="{{ route('categories.sectionstore', Crypt::encrypt($parentDetails->id)) }}" method="post" enctype="multipart/form-data">
                @csrf
              ...
              <div class="card-body p-5">
                ...
                <div class="form-colum">
                  <div class="mb-4">
                    ...
                    <input type="hidden" name="category_id" value="{{ $parentDetails->id }}"  />
                  </div>  
                    <div class="mb-4">
