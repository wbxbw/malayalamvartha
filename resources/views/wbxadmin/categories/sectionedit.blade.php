      ...
      <div class="sa-entity-layout" data-sa-container-query='{"920":"sa-entity-layout--size--md","1100":"sa-entity-layout--size--lg"}' >
        <div class="sa-entity-layout__body">
          <div class="sa-entity-layout__main">
            <div class="card">
            <form action="{{ route('categories.sectionupdate', $section['id'] ) }}" method="post" enctype="multipart/form-data">
            @csrf
            @method('PUT')
              <div class="card-body p-5">
                ...
                <div class="form-colum">
                  <div class="mb-4">
                    ...
                    <input type="hidden" name="section_id" value="{{ $parentDetails->id }}"  />
                  </div>
                  <div class="mb-4">
                  ...
                  <div class="mb-4">
                    <label for="first-name" class="form-label">Section Type</label>
                      <select class="form-select" name="function_ret" id="sectiontype">
                        ...
                        <option value="twoSectionSlider" {{ $section['function_ret'] == 'twoSectionSlider' ? 'selected' : '' }}>2 Col Banner - Carousel</option>
                        <option value="threeSectionSlider" {{ $section['function_ret'] == 'threeSectionSlider' ? 'selected' : '' }}>3 Col Banner - Carousel</option>
                        <option value="twoSectionSliderFixed" {{ $section['function_ret'] == 'twoSectionSliderFixed' ? 'selected' : '' }}>2 Col Banner - Featured</option>
                        <option value="threeSectionSliderFixed" {{ $section['function_ret'] == 'threeSectionSliderFixed' ? 'selected' : '' }}>3 Col Banner - Featured</option>
                        <option value="fourSectionSliderFixed" {{ $section['function_ret'] == 'fourSectionSliderFixed' ? 'selected' : '' }}>4 Col Banner - Featured</option>
                        <option value="sixSectionSliderFixed" {{ $section['function_ret'] == 'sixSectionSliderFixed' ? 'selected' : '' }}>6 Col Banner - Featured</option>
                        <option value="yellowRoundSlider" {{ $section['function_ret'] == 'yellowRoundSlider' ? 'selected' : '' }}>9 Col Banner - Yellow</option>
                        <option value="brandList" {{ $section['function_ret'] == 'brandList' ? 'selected' : '' }}>Brand List</option>
                      </select>
                  </div>
                    <div class="mb-4">
...
@foreach($images as $image)
<form action="{{ route('category.imageupdate', $image['id'] ) }}" method="post" enctype="multipart/form-data" >
  @csrf
  @method('PUT')
<div class="offcanvas offcanvas-end offcanvas-sa-card" tabindex="-1" id="fileManagerDetails{{ $image['id']}}" aria-labelledby="fileManagerDetailsLabel">
  ...
  <div class="offcanvas-body" data-simplebar="">
      ...
      <div class="hstack gap-3"><button type="submit" class="btn btn-primary flex-grow-1">Update</button><a href="{{ route('sectioncat.imgdel', $image['id'] ) }}" class="btn btn-secondary flex-grow-1">Delete</a></div>
  </div>
</div>
</form>
@endforeach
