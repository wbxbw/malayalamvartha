                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12">
                            <div class="mb-4">
                                ...
                                <input type="text" placeholder="Page Name" class="form-control" id="titleInput" name="name" value="{{ $category['name'] }}" />
                              </div>
                        </div>
                        <div class="col-lg-12 col-md-12">
                            <div class="mb-4">
                              ...
                              <div class="input-group input-group--sa-slug">
                                <span class="input-group-text" id="form-product/slug-addon" >{{ $settings->values }}/category/</span >
                                <input type="text" class="form-control" id="slugOutput" name="link" aria-describedby="form-product/slug-addon form-product/slug-help" value="{{ $category['link'] }}"/>
                              </div>
                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="mb-4">
                                ...
                                <input type="text" placeholder="Meta Title" class="form-control" id="meta_title" name="meta_title" value="{{ $category['meta_title'] }}" />
                              </div>
                        </div>
                    </div>
                    <div class = "mb-4">
                    <label for="meta-keywords" class="form-label ">Meta Keywords</label>
                        <textarea placeholder="Text Area" class="form-control" rows="3" id="meta_keyword" name="meta_keyword">{{ $category['meta_keyword'] }}</textarea> 
                    </div>
                    <div class = "mb-3">
                    <label for="meta-keywords" class="form-label">Meta Description</label>
                    <textarea placeholder="Text Area" class="form-control" rows="3" id="meta_description" name="meta_description">{{ $category['meta_description'] }}</textarea> 
                    </div>   
                    <!-- <div class="mb-4">
                        ...
                        <div class="col-lg-2 col-md-2">
                            <div class="mb-4">
                              ...
                              <div class="sa-symbol sa-symbol--shape--rounded sa-symbol--size--lg">
                                  <img <?php if ($category['img'] != '') { ?> src="{{ url('wx.images/categories/'.$category['img']) }}" <?php } else { ?> src="{{ url('sample/imgpreview.png') }}" <?php } ?> id="previmg" width="40" height="40" alt="">
                              </div>
                            </div>
                        </div>
          ...
          <div class="sa-entity-layout__sidebar">
              ...
              <div class="card w-100 mt-5">
                <div class="card-body p-5">
                  ...
                  @php $selected = in_array($brand->id, $categoryBrands); @endphp
