        ...
        <table class="sa-datatables-init" data-sa-search-input="#table-search" >
          ...
          @foreach ($specifications as $specification)
            <tr>
              ...
              <td>
                <a href="{{ route('categories.editspec',Crypt::encrypt($specification['id']))}}" class="text-reset">{{ $specification['name'] }}</a>
              </td>
              <td>
              <div class="notification-box">
                <a href="{{ route('categories.specvalues',Crypt::encrypt($specification['id']))}}">
