  ...
  <div class="mx-sm-2 px-2 px-sm-3 px-xxl-4 pb-6">
    <div class="container">
      ...
      <div class="card">
        <div class="p-4">
        <div class="mb-5">
            <h2 class="mb-0 fs-exact-18"><a href="{{ route('categories.index')}}">Categories /</a> {{ $category['name'] }} </h2>
        </div>
        <div class="mb-5">
            <h2 class="mb-0 fs-exact-18"><a href="{{ route('categories.specifications',Crypt::encrypt($category['id']))}}">Specifications /</a> {{ $specifications['name'] }} </h2>
        </div>
          <input
            type="text"
        ...
        <table class="sa-datatables-init" data-sa-search-input="#table-search" >
          ...
          @foreach ($specvalues as $specvalue)
            <tr>
              ...
              <td>
                <a href="{{ route('categories.editspecvalue',Crypt::encrypt($specvalue['id']))}}" class="text-reset">{{ $specvalue['name'] }}</a>
              </td>
              <td>
              ...
              <td>
                <div class="dropdown">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="category-context-menu-0" >
                    <li><a class="dropdown-item" href="{{ route('categories.editspecvalue',Crypt::encrypt($specvalue['id']))}}">Edit</a></li>
                    <!-- <li>
