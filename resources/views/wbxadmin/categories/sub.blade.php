  ...
  <div class="mx-sm-2 px-2 px-sm-3 px-xxl-4 pb-6">
    <div class="container">
      <div class="py-5">
        ...
        <div class="col">
          ...
          <div class="col-auto d-flex">
            <a href="{{ route('categories.create',['parent' => Crypt::encrypt($parentDetails->id)])}}" class="btn btn-primary"
              >New category</a
            >
          </div>
        </div>
      ...
      <div class="card">
        <div class="p-4">
        <div class="mb-5">
            <h2 class="mb-0 fs-exact-18">{{ $breadcrumbs }} /</h2>
        </div>
          <input
            type="text"
        ...
        <table class="sa-datatables-init" data-sa-search-input="#table-search" >
          ...
          @foreach ($categories as $category)
            <tr>
              ...
              <td>
                <a href="{{ route('categories.edit',Crypt::encrypt($category['id']))}}" class="text-reset">{{ $category['name'] }}</a>
              </td>
              <td><div class="badge badge-sa-success">Visible</div></td>
              <td>
              <div class="notification-box">
                <a href="{{ route('categories.subindex',Crypt::encrypt($category['id']))}}">
              ...
              <td>
                <div class="notification-box">
                  <a href="{{ route('categories.section',Crypt::encrypt($category['id']))}}">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="black" class="bi bi-card-text" viewBox="0 0 16 16">
                      <path d="M14.5 3a.5.5 0 0 1 .5.5v9a.5.5 0 0 1-.5.5h-13a.5.5 0 0 1-.5-.5v-9a.5.5 0 0 1 .5-.5h13zm-13-1A1.5 1.5 0 0 0 0 3.5v9A1.5 1.5 0 0 0 1.5 14h13a1.5 1.5 0 0 0 1.5-1.5v-9A1.5 1.5 0 0 0 14.5 2h-13z" />
                      <path d="M3 5.5a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5zM3 8a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9A.5.5 0 0 1 3 8zm0 2.5a.5.5 0 0 1 .5-.5h6a.5.5 0 0 1 0 1h-6a.5.5 0 0 1-.5-.5z" />
                    </svg>
                    <span class="notification-counter">{{ $category->sub_sections_count }}</span>
                  </a>
                </div>
              </td>
              <td>
              <div class="notification-box">
                <a href="{{ route('categories.specifications',Crypt::encrypt($category['id']))}}">
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="black" class="bi bi-card-text" viewBox="0 0 16 16">
                    <path d="M14.5 3a.5.5 0 0 1 .5.5v9a.5.5 0 0 1-.5.5h-13a.5.5 0 0 1-.5-.5v-9a.5.5 0 0 1 .5-.5h13zm-13-1A1.5 1.5 0 0 0 0 3.5v9A1.5 1.5 0 0 0 1.5 14h13a1.5 1.5 0 0 0 1.5-1.5v-9A1.5 1.5 0 0 0 14.5 2h-13z"/>
                    <path d="M3 5.5a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5zM3 8a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9A.5.5 0 0 1 3 8zm0 2.5a.5.5 0 0 1 .5-.5h6a.5.5 0 0 1 0 1h-6a.5.5 0 0 1-.5-.5z"/>
                  </svg>
              ...
              <td>
                <div class="dropdown">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="category-context-menu-0" >
                    <li><a class="dropdown-item" href="{{ route('categories.edit',Crypt::encrypt($category['id']))}}">Edit</a></li>
                    <!-- <li>
