        ...
        <table
          ...
          @foreach ($contents as $content)
            <tr>
              ...
              <td><a href="{{ route('blogs.edit',Crypt::encrypt($content['id']))}}" class="text-reset">{{ $content['name'] }}</a></td>
              ...
              <td>
                <div class="dropdown">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="customer-context-menu-0">
                    <li>
                      <a class="dropdown-item" href="{{ route('blogs.edit',Crypt::encrypt($content['id']))}}">Edit</a>
                    </li>
                  </ul>
                </div>
              </td>
