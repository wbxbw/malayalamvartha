                ...
                <div class="card-body p-5">
                  ...
                  <div class="form-colum">
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12">
                            <div class="mb-4">
                                ...
                                <input type="text" placeholder="Page Name" class="form-control" id="titleInput" name="name" value="{{ $content['name'] }}" />
                              </div>
                        </div>
                        <div class="col-lg-12 col-md-12">
                            <div class="mb-4">
                    ...
                    <div class="mb-4">
                      ...
                      <textarea class="sa-quill-control form-contr  ol" rows="1" id="short_description" name="short_description">{{ $content['short_description'] }}</textarea>
                    </div>
                    <div class="mb-4">
                      <label for="first-name" class="form-label">Long Description</label>
                      <textarea class="sa-quill-control form-control" rows="1" id="long_description" name="long_description">{!! $content['long_description'] !!}</textarea>
                    </div>
                  </div>
                </div>
                        ...
                        <tr>
                            <td>
                              <div class="sa-symbol sa-symbol--shape--rounded sa-symbol--size--lg">
                                <img src="{{ url('wx.images/contents/articles/'.$image['image']) }}" width="40" height="40" alt="">
                              </div>
                            </td>
                            <td>
                                <input type="file" name="images[]" value="" class="form-control" onchange="previewImage(this)">
                            </td>
                            <td>
                                <input type="text" name="alt[]" value="{{ $image['alt'] }}" class="form-control form-control-sm"/>
                            </td>
                            <td>
                                <input type="number" name="order[]" value="{{ $image['ord'] }}" class="form-control form-control-sm w-4x" />
                            </td>
                            <td>
...
function addTableRowSpecial() {
        ...
        // Find the order input in the cloned row
        var orderInput = lastRow.querySelector("input[name='order[]']");
