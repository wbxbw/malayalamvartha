                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="mb-4">
                                ...
                                <input type="email" class="form-control" id="last-name" name="email" value="{{ $user['email'] }}" />
                              </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-6 col-md-6">
                            <div class="mb-4">
                                ...
                                <input type="text" class="form-control" id="username" name="phone" value="{{ $user['phone'] }}" />
                              </div>
                        </div>
                    </div> 
