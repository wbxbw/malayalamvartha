...
<div id="top" class="sa-app__body">
  <div class="mx-sm-2 px-2 px-sm-3 px-xxl-4 pb-6">
    <div class="container">
      ...
      <form action="{{ route('contents.sectionstore', Crypt::encrypt($parentDetails->id)) }}" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-colum">
                  ...
                  <div class="mb-4">
                      ...
                      <select class="form-select" name="function_ret" id="primarySelect" onchange="TagValueShow();">
                          ...
                          <option value="MenuLink">Menu Link</option>
                          <option value="MenuLinkSub">Menu Link - Sub</option>
                          <option value="tagNews">Tag News</option>
                          <option value="catNews">Category News</option>
