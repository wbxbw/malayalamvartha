    ...
    <div class="container">
      <div class="py-5">
        <div class="row g-4 align-items-center">
          ...
          <div class="col-auto d-flex">
            <a href="{{ route('stores.create',['parent' => Crypt::encrypt(0)])}}" class="btn btn-primary"
              >New Store</a
            >
          </div>
        </div>
      ...
      <div class="card">
        ...
        <table
          ...
          <tbody>
          @foreach ($stores as $content)
            <tr>
              <td>{{ $loop->iteration }}</td>
              <td><a href="{{ route('stores.edit',Crypt::encrypt($content['id']))}}" class="text-reset">{{ $content['name'] }}</a></td>
              <td class="text-nowrap "> {{ $content['contact'] }} </td>
              <td class="text-nowrap "> {{ $content['address'] }} </td>
              <!-- <td>
                <a href="#">
              ...
              <td>
                <div class="dropdown">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="customer-context-menu-0">
                    <li>
                      <a class="dropdown-item" href="{{ route('stores.edit',Crypt::encrypt($content['id']))}}">Edit</a>
                    </li>
                  </ul>
                </div>
              </td>
