                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12">
                            <div class="mb-4">
                                ...
                                <input type="text" placeholder="Store Name" class="form-control" id="name" name="name" value="{{ $store['name'] }}" />
                              </div>
                        </div>
                    </div>
                    <div class="mb-4">
                        <label for="meta-tittle" class="form-label">Store Address</label>
                        <textarea placeholder="Address" class="form-control" rows="3" id="address" name="address">{{ $store['address'] }}</textarea> 
                    </div>
                    <div class="mb-4">
                        <label for="meta-keywords" class="form-label ">Store Contact</label>
                        <input type="text" placeholder="Contact" class="form-control" id="contact" name="contact" value="{{ $store['contact'] }}" />
                    </div>
                    <div class="mb-4">
                        <label for="meta-keywords" class="form-label ">Store Location</label>
                        <input type="text" placeholder="Store Location" class="form-control" id="location" name="location" value="{{ $store['location'] }}" />
                    </div>
                    <div class="mb-4">
                          ...
                          <textarea class="form-control" name="description" id="editor2" cols="43" rows="5" class="textarea" tabindex="5" onkeydown="limitText(this.form.short_desc,this.form.countdown1,5000);"
                            onkeyup="limitText(this.form.product_desc,this.form.countdown1,5000);">{{ $store['description'] }}</textarea>
                    </div>   
                  </div>
                </div>
            ...
            <div class="card w-100">
                <div class="card-body p-5">
                  ...
                  <div class="mb-4">
                    ...
                    <input type="disabled" class="form-control" data-auto-close="true" data-language="en" value="{{ date('d-M-Y', strtotime($store['created_at'])) }}" />
                  </div>
                  <div class="mb-4">
                    <label for="form-product/seo-title" class="form-label" >Updated date</label > 
                    <input type="disabled" class="form-control" data-auto-close="true" data-language="en" value="{{ date('d-M-Y', strtotime($store['updated_at'])) }}" /><label class="form-check mb-0" >
                  </div>
                </div>
