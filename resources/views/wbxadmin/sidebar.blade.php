          ...
          <div class="sa-sidebar__header">
            <a class="sa-sidebar__logo" href="index.html">
              <div class="sa-sidebar-logo">
                <img src="{{ url('admin/images/logo.png') }}" width="150px" alt="WBX Admin Logo">
              </div>
            </a>
          </div>
              ...
              <li class="sa-nav__section">
                ...
                <ul class="sa-nav__menu sa-nav__menu--root">
                  <li class="sa-nav__menu-item sa-nav__menu-item--has-icon">
                    <a href="{{ route('wbxadmin') }}" class="sa-nav__link"
                  ...
                  <li class="sa-nav__menu-item sa-nav__menu-item--has-icon" data-sa-collapse-item="sa-nav__menu-item--open">
                    <a href="#" class="sa-nav__link" data-sa-collapse-trigger="">
                      ...
                      <span class="sa-nav__title">{{ $module['title'] }}</span>
                    ...
                    @foreach ($pages as $page)
                     @if ($page->module_id == $module->id)
                      <li class="sa-nav__menu-item">
                        <a href="{{ route($page->link) }}" class="sa-nav__link"><span class="sa-nav__menu-item-padding"></span>
                        <span class="sa-nav__title">{{ $page->name }}</span></a>
                      </li>
                      @endif
                    @endforeach
                    @endif
                    @if (auth()->user()->isGeneralAdmin())
                        @foreach ($pages as $page)
                            @if (is_object($page) && $page->module_id == $module->id)
                                <li class="sa-nav__menu-item">
                                    <a href="{{ route($page->link) }}" class="sa-nav__link">
                                        <span class="sa-nav__menu-item-padding"></span>
                                        <span class="sa-nav__title">{{ $page->name }}</span>
                                    </a>
                                </li>
                            @endif
                        @endforeach
                  ...
                  <li class="sa-nav__menu-item sa-nav__menu-item--has-icon" data-sa-collapse-item="sa-nav__menu-item--open">
                    <a href="#" class="sa-nav__link" data-sa-collapse-trigger="">
                      ...
                      <span class="sa-nav__title">{{ $category->name }} News</span>
                      <span class="sa-nav__arrow">
                        <svg xmlns="http://www.w3.org/2000/svg" width="6" height="9" viewBox="0 0 6 9" fill="currentColor" >
                          <path d="M5.605,0.213 C6.007,0.613 6.107,1.212 5.706,1.612 L2.696,4.511 L5.706,7.409 C6.107,7.809 6.107,8.509 5.605,8.808 C5.204,9.108 4.702,9.108 4.301,8.709 L-0.013,4.511 L4.401,0.313 C4.702,-0.087 5.304,-0.087 5.605,0.213 Z"></path>
                        </svg>
                    ...
                    @foreach ($pages as $page)
                     @if ($page->module_id == $module->id)
                      <li class="sa-nav__menu-item">
                        <a href="{{ route($page->link) }}?category={{ $category->link }}" class="sa-nav__link"><span class="sa-nav__menu-item-padding"></span>
                        <span class="sa-nav__title">{{ $page->name }}</span></a>
                      </li>
                      @endif
                    @endforeach
                    ...
                    @if (auth()->user()->isGeneralAdmin())
                        @foreach ($pages as $page)
                            @if (is_object($page) && $page->module_id == $module->id)
                                <li class="sa-nav__menu-item">
                                    <a href="{{ route($page->link) }}?category={{ $category->link }}" class="sa-nav__link">
                                        <span class="sa-nav__menu-item-padding"></span>
                                        <span class="sa-nav__title">{{ $page->name }}</span>
                                    </a>
                                </li>
