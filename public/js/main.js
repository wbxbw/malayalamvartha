...
document.addEventListener('DOMContentLoaded', function () {
  ...
  function moveSlide(step) {
      ...
      // Only allow the slideIndex to update if it stays within bounds
      if (newIndex >= 0 && newIndex < document.querySelectorAll('.slide').length) {
          showSlide(newIndex);
      }
  }
  ...
  setInterval(function () {
      moveSlide(1); // Move to next slide automatically
  }, intervalTime);
