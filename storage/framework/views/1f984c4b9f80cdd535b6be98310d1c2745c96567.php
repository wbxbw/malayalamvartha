        ...
        <div class="multisteps-form mb-5">
            <div class="row">
                <div class="col-12 col-lg-12 m-auto">
                    <form class="multisteps-form__form mb-8" action="<?php echo e(route('products.update', $product['id'])); ?>" method="post" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?></label>
                                        <input class="multisteps-form__input form-control" type="text" name="name" id="name" placeholder="eg. Product Name" value="<?php echo e($product['name']); ?>" />
                                    </div>
                                    <div class="col-12 col-sm-6 mt-3 mt-sm-0">
...
unset($__errorArgs, $__bag); ?></label>
                                        <select name="sector_id" id="sector_id" class="multisteps-form__input form-control">
                                            ...
                                            <option value="<?php echo e($sector['id']); ?>" <?php echo e($product['sector_id'] == $sector['id'] ? 'selected' : ''); ?>><?php echo e($sector['name']); ?></option>
...
unset($__errorArgs, $__bag); ?></label>
                                        <div class="choices">
                                            <input class="multisteps-form__input form-control choices__input" type="text" name="category" id="category-search" placeholder="eg. Category" value="<?php echo e($product['category']); ?>" />
...
unset($__errorArgs, $__bag); ?></label>
                                        <div class="choices">
                                            <input class="multisteps-form__input form-control choices__input" type="text" name="sub_category" id="sub-category-search" placeholder="eg. Sub Category" value="<?php echo e($product['sub_category']); ?>" />
...
unset($__errorArgs, $__bag); ?></label>
                                        <select name="org_id" id="org_id" class="multisteps-form__input form-control">
                                            ...
                                            <option value="<?php echo e($org['id']); ?>" <?php echo e($product['org_id'] == $org['id'] ? 'selected' : ''); ?>><?php echo e($org['name']); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    </div>
                                </div>
...
<?php echo $__env->make('wbxadmin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/qotz/resources/views/wbxadmin/products/edit.blade.php ENDPATH**/ ?>