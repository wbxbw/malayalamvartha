  ...
  <div class="mx-sm-2 px-2 px-sm-3 px-xxl-4 pb-6">
    <div class="container">
      <div class="py-5">
        ...
        <div class="col">
          ...
          <div class="col-auto d-flex">
            <a href="<?php echo e(route('categories.createspec', [Crypt::encrypt($category->id)] )); ?>" class="btn btn-primary"
              >New Specification</a
            >
          </div>
        </div>
      ...
      <div class="card">
        <div class="p-4">
        <div class="mb-5">
            <h2 class="mb-0 fs-exact-18"><a href="<?php echo e(route('categories.index')); ?>">Categories</a> / <?php echo e($category['name']); ?> </h2>
        </div>
          <input
            type="text"
        ...
        <table class="sa-datatables-init" data-sa-search-input="#table-search" >
          ...
          <?php $__currentLoopData = $specifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $specification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
              ...
              <td>
                <a href="<?php echo e(route('categories.editspec',Crypt::encrypt($specification['id']))); ?>" class="text-reset"><?php echo e($specification['name']); ?></a>
              </td>
              <td>
              <div class="notification-box">
                <a href="<?php echo e(route('categories.specvalues',Crypt::encrypt($specification['id']))); ?>">
                  ...
                  <span class="notification-counter"><?php echo e($specification->spec_vlues_count); ?></span> <!-- Change the number to your notification count -->
                </a>
              </div>
              </td>
              <td>
                <?php if($specification['status'] == 'N'): ?>
                <div class="badge badge-sa-danger">Disabled</div>
                <?php endif; ?>
                <?php if($specification['status'] == 'Y'): ?>
              ...
              <td>
                <div class="dropdown">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="category-context-menu-0" >
                    <li><a class="dropdown-item" href="<?php echo e(route('categories.editspec',Crypt::encrypt($specification['id']))); ?>">Edit</a></li>
                    <!-- <li>
...
<?php echo $__env->make('wbxadmin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/luluconnect/resources/views/wbxadmin/categories/spec.blade.php ENDPATH**/ ?>