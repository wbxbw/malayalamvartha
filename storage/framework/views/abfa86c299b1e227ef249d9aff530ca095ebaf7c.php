                ...
                <div class="form-colum">
                  ...
                  <div class="row" id="pagefields" style="display:block;">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" placeholder="External Link" class="form-control" id="ext_link" name="ext_link" />
                    </div>
...
<?php echo $__env->make('wbxadmin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/luluconnect/resources/views/wbxadmin/products/create.blade.php ENDPATH**/ ?>