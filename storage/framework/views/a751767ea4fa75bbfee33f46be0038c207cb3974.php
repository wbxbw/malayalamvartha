        ...
        <table
          ...
          <?php $__currentLoopData = $contents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $content): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
              ...
              <td><a href="<?php echo e(route('blogs.edit',Crypt::encrypt($content['id']))); ?>" class="text-reset"><?php echo e($content['name']); ?></a></td>
              ...
              <td>
                <div class="dropdown">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="customer-context-menu-0">
                    <li>
                      <a class="dropdown-item" href="<?php echo e(route('blogs.edit',Crypt::encrypt($content['id']))); ?>">Edit</a>
                    </li>
                  </ul>
                </div>
              </td>
...
<?php echo $__env->make('wbxadmin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/luluconnect/resources/views/wbxadmin/blogs/index.blade.php ENDPATH**/ ?>