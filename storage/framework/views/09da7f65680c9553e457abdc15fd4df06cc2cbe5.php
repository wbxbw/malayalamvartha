          ...
          <div class="sa-entity-layout__body">
                ...
                <div class="card-body p-5">
                  ...
                  <div class="form-colum">
                    ...
                    <div class="row" id="pagefields" style="display:block;">
                      ...
                      <div class="mb-4">
                        <label for="meta-tittle" class="form-label">External Link</label>
                        <input type="text" placeholder="External Link" class="form-control" id="ext_link" name="ext_link" value="<?php echo e($product['ext_link']); ?>" />
                    </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="mb-4">
                              ...
                              <input type="number" min="0" max="100" placeholder="%" class="form-control" id="discount" name="discount" value="<?php echo e($product['discount']); ?>" />
                            </div>
                        </div>
                  </div>
                    <div class="row">
                      <div class="mb-4">
                          ...
                          <input type="number" placeholder="Stock" class="form-control" id="stock" name="stock" value="<?php echo e($product['stock']); ?>" />
                      </div>
                      <div class="mb-4">
            ...
            <div class="sa-entity-layout__sidebar">
                  ...
                  <div class="mb-4">
                      ...
                      <select class="form-select" name="brand" id="brand">
                            ...
                            <?php $__currentLoopData = $brands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $brand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($brand->id); ?>" <?php if($product['brand'] == $brand->id) { ?> selected <?php } ?> ><?php echo e($brand->name); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                      </select>
                  </div>
                  <div class="mb-4">
                      <label for="name" class="form-label">Product Unique Id</label>
                      <input type="text" placeholder="PRD0001253" class="form-control" name="unique_id" value="<?php echo e($product['unique_id']); ?>" />
                  </div>
              ...
              <div class="card w-100 mt-5">
                <div class="card-body p-5">
                  <div class="mb-5">
                    <h2 class="mb-0 fs-exact-18">Specifications</h2>
                  </div>
                  <select id="selectOptions" name="selectOptions[]" class="sa-select2 form-select" multiple="">
                    <?php $__currentLoopData = $specifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $specification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <?php $__currentLoopData = $specification->SpecVlues; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $specValue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <?php $selected = false; ?>
                          <?php $__currentLoopData = $productSpec; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $productSpecD): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <?php if($productSpecD['spec_value_id'] == $specValue['id']): ?>
                                  <?php $selected = true; ?>
                                  <?php break; ?>
                              <?php endif; ?>
                          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                          <option value="<?php echo e($specValue['id']); ?>" <?php echo e($selected ? 'selected' : ''); ?>>
                              <?php echo e($specification['name']); ?> - <?php echo e($specValue['name']); ?>
...
<?php echo $__env->make('wbxadmin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/luluconnect/resources/views/wbxadmin/products/edit.blade.php ENDPATH**/ ?>