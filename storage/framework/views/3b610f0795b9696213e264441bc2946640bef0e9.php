        ...
        <div class="sa-entity-layout__body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="mb-4">
                                ...
                                <input type="text" placeholder="Meta Title" class="form-control" id="meta_title" name="meta_title" value="<?php echo e($category['link']); ?>" />
                              </div>
                        </div>
                    </div>
                    <div class = "mb-4">
                    ...
                    <h2 class="mb-0 fs-exact-18">Specifications</h2>
                        ...
                        <div class="d-flex flex-wrap gap-2 mt-4">
                            <?php $__currentLoopData = $specifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $spec): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <span class="badge bg-dark"><?php echo e($spec->name); ?></span>
          ...
          <div class="sa-entity-layout__sidebar">
            ...
            <div class="card w-100 mt-4">
                <form action="<?php echo e(route('categories.addSpec',$category['id'])); ?>" method="post" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                <div class="card-body p-5">
                  <div class="mb-5">
                    <h2 class="mb-0 fs-exact-18">Specification Config</h2>
                  </div>
                  <div class="mb-4">
                  ...
                  <div>
                    <label for="form-product/seo-title" class="form-label" >Specification Title</label >
                    <input type="text" class="form-control" name="name" />
                  </div>
                  <div>
                    <label for="form-product/seo-title" class="form-label" >Specification description</label >
            ...
            <div class="card w-100 mt-4">
                <form action="<?php echo e(route('categories.addSpecVal',$category['id'])); ?>" method="post" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                <div class="card-body p-5">
                  <div class="mb-5">
                    <h2 class="mb-0 fs-exact-18">Specification Config</h2>
                  ...
                  <div>
                    <label for="form-product/seo-title" class="form-label" >Specification value</label >
                    <input type="text" class="form-control" name="name" />
                  </div>
                  <div>
                    <label for="form-product/seo-title" class="form-label" >Description</label >
                   <textarea name="description" id="" cols="30" rows="10" class="form-control"></textarea>
                    </div>
...
<?php echo $__env->make('wbxadmin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\saswa\Downloads\ecommerceadmin\ecommerceadmin\resources\views/wbxadmin/categories/edit.blade.php ENDPATH**/ ?>