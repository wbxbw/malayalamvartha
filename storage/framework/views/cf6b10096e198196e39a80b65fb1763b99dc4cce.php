              ...
              <div class="card-body p-5">
                ...
                <div class="form-colum">
                  <div class="mb-4">
                      ...
                      <input type="text" placeholder="News Title" class="form-control" id="titleInput" name="name" />
                  </div>
                  <div class="row" id="pagefields" style="display:block;">
                    <div class="mb-4">
                      <label for="form-product/slug" class="form-label">Slug</label>
                      <div class="input-group input-group--sa-slug">
                        <span class="input-group-text" id="form-product/slug-addon" ><?php echo e($settings->values); ?>/news/</span >
                    ...
                    <div class="mb-4">
                        <label for="meta-tittle" class="form-label">Meta Title</label>
...
<?php echo $__env->make('wbxadmin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/newsportal/resources/views/wbxadmin/products/create.blade.php ENDPATH**/ ?>