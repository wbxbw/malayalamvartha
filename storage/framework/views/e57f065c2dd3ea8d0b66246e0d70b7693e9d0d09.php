...
<html lang="en" dir="ltr" data-scompiler-id="0">
  <head>
    ...
    <title><?php echo e($setting->values); ?> - <?php echo e($pageDetails->title); ?></title>
    <link rel="icon" type="image/png" href="<?php echo e(url('admin/images/favicon.png')); ?>" />
    ...
    <link rel='stylesheet' type='text/css' href="<?php echo e(url('admin/summernote/summernote-bs4.css')); ?>"/>
    ...
    <script src="<?php echo e(url('admin/js/clock.js')); ?>"></script>
  </head><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/luluconnect/resources/views/wbxadmin/head.blade.php ENDPATH**/ ?>