<nav
    ...
    style="background-color: #0d4f9d;padding:0;">
    <div class="container" style="display: list-item; list-style: none;">
        <div class="d-flex d-lg-none justify-content-between">
            <div class="d-flex">
                <a class="logo-link mt-3" href="<?php echo e(route('home.index')); ?>">
                    <img src="<?php echo e(url('assets/browire-sam-logo-1.png')); ?>" alt=""></a>
                    <a href="#" class="menu-link d-flex mt-4" onclick="openNav1()">
                        <img class="menu-icon" src="<?php echo e(url('assets/align-left.png')); ?>" alt="Menu Icon"/>
                ...
                <div class="navbar-collapse d-lg-flex" id="navbarSupportedContent">
                    <div class="px-1">
                        <ul class="navbar-nav mb-2 mb-lg-0">
                            ...
                            <li class="nav-item">
                                <a class="navbar logo-link" href="<?php echo e(route('home.index')); ?>">
                                    <img src="<?php echo e(url('assets/browire-sam-logo-1.png')); ?>" alt=""></a>
                                </li>
                                ...
                                <li class="nav-item  ">
                                    <div class="dropdown mt-4">
                                        ...
                                        <a href="javascript:void(0)" class="closebtn" onclick="closeNav()">x</a>
                                         ...
                                         <?php $__currentLoopData = $menucontents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menucontent): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                          <button class="dropdown-btn"><a href="<?php echo e($menucontent->description); ?>"><?php echo e($menucontent->name); ?></a></button>
                                          <hr>
                                         <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                          ...
                                          <button class="dropdown-btn"> <i class="bi bi-tag-fill mx-2"></i>Category
                                            ...
                                            <ul class="dropdown-nav">
                                                <?php $categories = DB::table('categories')->where('parent', 0)->get(); ?>
                                                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <li class="dropdown-item">

                                                    <?php $subcategories = DB::table('categories')->where('parent',
                                                    $category->id)->get(); ?>


                                                    <a href="<?php echo e(route('home.index').'/products/'.$category->link); ?>"><?php echo e($category->name); ?></a>
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li class="nav-link dropdown-item-one">

                                                            <?php $sub = DB::table('categories')->where('parent', $subcategory->id)->get();
                                                            ?>


                                                            <a href="<?php echo e(route('home.index').'/products/'.$subcategory->link); ?>"><?php echo e($subcategory->name); ?></a>



                                                            <?php if(count($sub)>0): ?>
                                                            <ul>
                                                                <?php $__currentLoopData = $sub; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <li class="nav-link">
                                                                    <a href="<?php echo e(route('home.index').'/products/'.$subc->link); ?>"><?php echo e($subc->name); ?></a>
                                                                </li>
                                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                            </ul>
                                                            <?php endif; ?>
                        ...
                        <div class="col-lg-5 col-xl-6 mx-5">
                            <form action="<?php echo e(route('home.searchresult')); ?>" method="post" id="search-form">
                                <?php echo csrf_field(); ?>
                                <div class="input-group mb-0">
                                    <span class="input-group-text">
                                        <i class="bi bi-search"></i>
                                    </span>
                                    <input class="form-control" type="text" name="srch_qry" id="search-input" placeholder="Search your products">
                                    <input type="hidden" name="search_type" id="search-type">
                                    ...
                                    <li class="nav-item dropdown pr-15px text-start" style="display: block;padding-right: 5px;">
                                      ...
                                      <a class="nav-link dropdown-toggle username " href="#" role="button" data-bs-toggle="dropdown"
                                        ...
                                        <div class="dropdown-a">
                                          Ernakulam, Kerala
                                          <!-- <i class="bi bi-chevron-down px-2" style="color:#B3B3B3;"></i> -->
                                        </div>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/luluconnect/resources/views/header.blade.php ENDPATH**/ ?>