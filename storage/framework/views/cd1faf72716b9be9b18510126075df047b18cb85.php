...
<div id="top" class="sa-app__body">
  <div class="mx-sm-2 px-2 px-sm-3 px-xxl-4 pb-6">
    <div class="container">
      ...
      <form action="<?php echo e(route('categories.sectionstore', Crypt::encrypt($parentDetails->id))); ?>" method="post" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
              ...
              <div class="card-body p-5">
                ...
                <div class="form-colum">
                  <div class="mb-4">
                    ...
                    <input type="hidden" name="category_id" value="<?php echo e($parentDetails->id); ?>"  />
                  </div>  
                    <div class="mb-4">
...
<?php echo $__env->make('wbxadmin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/luluconnect/resources/views/wbxadmin/categories/sectioncreate.blade.php ENDPATH**/ ?>