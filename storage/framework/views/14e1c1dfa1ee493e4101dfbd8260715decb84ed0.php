      ...
      <div class="py-5">
        ...
        <div class="col">
          ...
          <!-- <div class="col-auto d-flex">
            <a href="<?php echo e(route('guides.create')); ?>" class="btn btn-primary"
              >New guide</a
            >
          </div> -->
        </div>
...
<?php echo $__env->make('wbxadmin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/luluconnect/resources/views/wbxadmin/guides/index.blade.php ENDPATH**/ ?>