        ...
        <table
          ...
          <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
                  ...
                  <div>
                    ...
                    <div class="sa-meta mt-0">
                      <ul class="sa-meta__list">
                        <?php if ($product['unique_id']) { ?>
                        <li class="sa-meta__item">
                          ID: <span class="st-copy"><?php echo e($product['unique_id']); ?></span>
                        </li>
                        <?php } ?>
                        <?php if($product['stock'] == '0' || $product['stock'] == ''): ?>
                          <li class="sa-meta__item">
                        ...
                        <?php if($product['stock'] > 0): ?>
                          <li class="sa-meta__item">
                            SKU: <span class="st-copy"><?php echo e($product['stock']); ?></span>
                          </li>
                        <?php endif; ?>
                      </ul>
                    </div>
              ...
              <td>
                <div class="sa-price">
                  <span class="sa-price__integer"><?php echo e($formatted_price = number_format($product['price'], 2, '.', '')); ?></span>
                </div>
              </td>
              <!-- <td>
                <a href="#">
...
<?php echo $__env->make('wbxadmin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/luluconnect/resources/views/wbxadmin/products/index.blade.php ENDPATH**/ ?>