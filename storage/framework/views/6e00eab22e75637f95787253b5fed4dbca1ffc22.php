    ...
    <div class="container">
      <div class="py-5">
        <div class="row g-4 align-items-center">
          ...
          <div class="col-auto d-flex">
            <a href="<?php echo e(route('contents.create',['parent' => Crypt::encrypt($parentDetails->id)])); ?>" class="btn btn-primary"
              >New Content</a
            >
          </div>
        </div>
      ...
      <div class="card">
        ...
        <div class="mb-5">
          ...
          <input type="text" placeholder="Start typing to search for contents" class="form-control form-control--search mx-auto" id="table-search"/>
        </div>
        ...
        <table
          ...
          <tr>
            ...
            <th  data-orderable="false">Sub Contents</th>
...
<?php echo $__env->make('wbxadmin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/luluconnect/resources/views/wbxadmin/contents/sub.blade.php ENDPATH**/ ?>