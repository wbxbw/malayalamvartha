      ...
      <div class="sa-entity-layout" data-sa-container-query='{"920":"sa-entity-layout--size--md","1100":"sa-entity-layout--size--lg"}' >
        <div class="sa-entity-layout__body">
          <div class="sa-entity-layout__main">
            <div class="card">
            <form action="<?php echo e(route('categories.sectionupdate', $section['id'] )); ?>" method="post" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
              ...
              <div class="card-body p-5">
                ...
                <div class="form-colum">
                  <div class="mb-4">
                    ...
                    <input type="hidden" name="section_id" value="<?php echo e($parentDetails->id); ?>"  />
                  </div>
                  <div class="mb-4">
                  ...
                  <div class="mb-4">
                    <label for="first-name" class="form-label">Section Type</label>
                      <select class="form-select" name="function_ret" id="sectiontype">
                        ...
                        <option value="brandList" <?php echo e($section['function_ret'] == 'brandList' ? 'selected' : ''); ?>>Brand List</option>
                      </select>
                  </div>
                    <div class="mb-4">
...
<?php $__currentLoopData = $images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
<form action="<?php echo e(route('category.imageupdate', $image['id'] )); ?>" method="post" enctype="multipart/form-data" >
  <?php echo csrf_field(); ?>
  <?php echo method_field('PUT'); ?>
<div class="offcanvas offcanvas-end offcanvas-sa-card" tabindex="-1" id="fileManagerDetails<?php echo e($image['id']); ?>" aria-labelledby="fileManagerDetailsLabel">
  ...
  <div class="offcanvas-body" data-simplebar="">
      ...
      <div class="hstack gap-3"><button type="submit" class="btn btn-primary flex-grow-1">Update</button><a href="<?php echo e(route('sectioncat.imgdel', $image['id'] )); ?>" class="btn btn-secondary flex-grow-1">Delete</a></div>
  </div>
</div>
</form>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('wbxadmin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/luluconnect/resources/views/wbxadmin/categories/sectionedit.blade.php ENDPATH**/ ?>