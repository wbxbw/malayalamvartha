              ...
              <div class="card-body d-flex flex-column align-items-center" >
                <div class="pt-3">
                  <div class="sa-symbol sa-symbol--shape--circle" style="--sa-symbol--size: 6rem">
                    <img src="<?php echo e(url('admin/images/customers/customer-4-128x128.jpg')); ?>" width="96" height="96" alt="" />
                  </div>
                </div>
                <div class="text-center mt-4">
                  <div class="fs-exact-16 fw-medium"><?php echo e(Auth::user()->name); ?></div>
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6">
                            <div class="mb-4">
                                ...
                                <input type="text" class="form-control" id="first-name" name="first_name" value="<?php echo e(Auth::user()->name); ?>" />
                              </div>
                        </div>
                        <div class="col-lg-6 col-md-6">
                            <div class="mb-4">
                                <label for="last-name" class="form-label">Username</label>
                                <input disabled class="form-control" value="<?php echo e(Auth::user()->email); ?>" />
                              </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-6 col-md-6">
                            <div class="mb-4">
                                ...
                                <input type="text" class="form-control" id="username" name="email" value="<?php echo e(Auth::user()->email); ?>" />
                              </div>
                        </div>
                        <div class="col-lg-6 col-md-6">
                            <div class="mb-4">
...
<?php echo $__env->make('wbxadmin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/maichavx/public_html/lulu_demo/resources/views/wbxadmin/profile.blade.php ENDPATH**/ ?>