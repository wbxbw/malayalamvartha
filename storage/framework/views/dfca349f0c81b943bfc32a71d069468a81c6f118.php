        ...
        <div class="row">
            <div class="col-12 col-lg-12 col-md-12 order-1 order-md-2">
                <div class="row justify-content-center divider p-10">
                    <div class="col-9">
                        <h5 class="h5">Search Results for "<?php echo e($srch); ?>"</h5>
                    </div>
                    ...
                    <div class="row pt-3 pb-3 ml-5px divider">
                        <div class="col col-12 d-flex justify-content-center align-items-center" style="height: 400px;">
                            <div class="no-products-wrapper">
                                ...
                                <p>We couldn't find any products matching your search criteria. Please try searching with different keywords or browse our categories for more products.</p>
                            </div>
                        </div>
                    </div>
                    <?php endif; ?>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/luluconnect/resources/views/searchresult.blade.php ENDPATH**/ ?>