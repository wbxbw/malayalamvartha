                    ...
                    <div class="mb-4">
                      <label for="first-name" class="form-label">Section Type</label>
                        <select class="form-select" name="function_ret" id="primarySelect" onchange="TagValueShow();">
                          ...
                          <option value="tagNews" <?php echo e($section['function_ret'] == 'tagNews' ? 'selected' : ''); ?>>Tag News</option>
                          <option value="catNews" <?php echo e($section['function_ret'] == 'catNews' ? 'selected' : ''); ?>>Category News</option>
...
<?php echo $__env->make('wbxadmin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/newsportal/resources/views/wbxadmin/contents/sectionedit.blade.php ENDPATH**/ ?>