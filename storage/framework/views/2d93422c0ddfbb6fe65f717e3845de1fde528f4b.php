...
<div id="top" class="sa-app__body">
  <div class="mx-sm-2 px-2 px-sm-3 px-xxl-4 pb-6">
    <div class="container">
      ...
      <form action="<?php echo e(route('guides.updatespecvalue', $specvalue['id'])); ?>" method="post">
        <?php echo csrf_field(); ?>
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12">
                            <div class="mb-4">
                                ...
                                <input disabled placeholder="Specification Name" class="form-control" id="titleInput" name="name" value="<?php echo e($specvalue['name']); ?>" />
                              </div>
                        </div>
                    </div>
                    <div class="mb-4">
                        ...
                        <textarea class="form-control" name="bg_description" id="summernote" cols="43" rows="5" class="textarea" tabindex="5" onkeydown="limitText(this.form.short_desc,this.form.countdown1,5000);"
                          onkeyup="limitText(this.form.product_desc,this.form.countdown1,5000);"><?php echo e($specvalue['bg_description']); ?></textarea>
                    </div>
...
<?php echo $__env->make('wbxadmin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/luluconnect/resources/views/wbxadmin/guides/editspecvalues.blade.php ENDPATH**/ ?>