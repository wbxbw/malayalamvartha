...
<div id="top" class="sa-app__body">
  <div class="mx-sm-2 px-2 px-sm-3 px-xxl-4 pb-6">
    <div class="container">
      ...
      <form action="<?php echo e(route('guides.update', $category['id'])); ?>" method="post" enctype="multipart/form-data">
                  <?php echo csrf_field(); ?>
                ...
                <div class="card-body p-5">
                  ...
                  <div class="form-colum">
                    ...
                    <div class="mb-4">
                      ...
                      <input type="text" placeholder="Meta Title" class="form-control" id="bg_title" name="bg_title" value="<?php echo e($category['bg_title']); ?>" />
                    </div>
                    <div class = "mb-4">
                    <label for="meta-keywords" class="form-label ">Guide Meta Keywords</label>
                        <textarea placeholder="Text Area" class="form-control" rows="3" id="bg_keywords" name="bg_keywords"><?php echo e($category['bg_keywords']); ?></textarea> 
                    </div>
                    <div class = "mb-3">
                    <label for="meta-keywords" class="form-label">Guide Meta Description</label>
                    <textarea placeholder="Text Area" class="form-control" rows="3" id="bg_description" name="bg_description"><?php echo e($category['bg_description']); ?></textarea> 
                    </div>   
                    <br>
                    <div class="row">
                        <div class="col-lg-2 col-md-2">
                            <div class="mb-4">
                              ...
                              <div class="sa-symbol sa-symbol--shape--rounded sa-symbol--size--lg">
                                  <img <?php if ($category['bg_banner'] != '') { ?> src="<?php echo e(url('wx.images/categories/'.$category['bg_banner'])); ?>" <?php } else { ?> src="<?php echo e(url('sample/imgpreview.png')); ?>" <?php } ?> id="previmg" width="40" height="40" alt="">
                              </div>
                            </div>
                        </div>
...
<?php echo $__env->make('wbxadmin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/luluconnect/resources/views/wbxadmin/guides/edit.blade.php ENDPATH**/ ?>