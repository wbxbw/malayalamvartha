...
<div id="top" class="sa-app__body">
  <div class="mx-sm-2 px-2 px-sm-3 px-xxl-4 pb-6">
    <div class="container">
      ...
      <form action="<?php echo e(route('categories.updatespecvalue', $specvalue['id'])); ?>" method="post" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12">
                            <div class="mb-4">
                                ...
                                <input type="text" placeholder="Specification Name" class="form-control" id="titleInput" name="name" value="<?php echo e($specvalue['name']); ?>" />
                              </div>
                        </div>
                    </div>
                    <div class = "mb-4">
                    <label for="meta-keywords" class="form-label ">Value Description</label>
                        <textarea placeholder="Description" class="form-control" rows="3" id="meta_keyword" name="description"><?php echo e($specvalue['description']); ?></textarea> 
                    </div>
          ...
          <div class="card w-100">
                  <div class="card-body p-5">
                    ...
                    <div class="mb-4">
                      ...
                      <input type="disabled" class="form-control" data-auto-close="true" data-language="en" value="<?php echo e(date('d-M-Y', strtotime($specvalue['created_at']))); ?>" />
                    </div>
                    <div class="mb-4">
                      <label for="form-product/seo-title" class="form-label" >Updated date</label > 
                      <input type="disabled" class="form-control" data-auto-close="true" data-language="en" value="<?php echo e(date('d-M-Y', strtotime($specvalue['updated_at']))); ?>" /><label class="form-check mb-0" >
                    </div>
                  </div>
                </div>
            </div>
...
<?php echo $__env->make('wbxadmin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/maichavx/public_html/lulu_demo/resources/views/wbxadmin/categories/editspecvalues.blade.php ENDPATH**/ ?>