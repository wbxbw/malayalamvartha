...
<div id="top" class="sa-app__body">
  <div class="mx-sm-2 px-2 px-sm-3 px-xxl-4 pb-6">
    <div class="container">
      ...
      <form action="<?php echo e(route('contents.sectionupdate', $section['id'] )); ?>" method="post" enctype="multipart/form-data">
      <?php echo csrf_field(); ?>
                ...
                <div class="card-body p-5">
                  ...
                  <div class="form-colum">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" placeholder="Section Name" class="form-control" id="titleInput" name="name" value="<?php echo e($section['name']); ?>" />
                    </div>
                    <div class="mb-4">
                      <label for="first-name" class="form-label">Section Type</label>
                        <select class="form-select" name="function_ret" id="primarySelect" onchange="TagValueShow();">
                          ...
                          <option value="textSection" <?php echo e($section['function_ret'] == 'textSection' ? 'selected' : ''); ?>>Text Section</option>
                          <option value="heroSlider" <?php echo e($section['function_ret'] == 'heroSlider' ? 'selected' : ''); ?>>Hero Banner</option>
                          <option value="twoSectionSlider" <?php echo e($section['function_ret'] == 'twoSectionSlider' ? 'selected' : ''); ?>>2 Col Banner - Carousel</option>
                          <option value="threeSectionSlider" <?php echo e($section['function_ret'] == 'threeSectionSlider' ? 'selected' : ''); ?>>3 Col Banner - Carousel</option>
                          <option value="twoSectionSliderFixed" <?php echo e($section['function_ret'] == 'twoSectionSliderFixed' ? 'selected' : ''); ?>>2 Col Banner - Featured</option>
                          <option value="threeSectionSliderFixed" <?php echo e($section['function_ret'] == 'threeSectionSliderFixed' ? 'selected' : ''); ?>>3 Col Banner - Featured</option>
                          <option value="fourSectionSliderFixed" <?php echo e($section['function_ret'] == 'fourSectionSliderFixed' ? 'selected' : ''); ?>>4 Col Banner - Featured</option>
                          <option value="sixSectionSliderFixed" <?php echo e($section['function_ret'] == 'sixSectionSliderFixed' ? 'selected' : ''); ?>>6 Col Banner - Featured</option>
                          <option value="yellowRoundSlider" <?php echo e($section['function_ret'] == 'yellowRoundSlider' ? 'selected' : ''); ?>>9 Col Banner - Yellow</option>
                          <option value="newsSection" <?php echo e($section['function_ret'] == 'newsSection' ? 'selected' : ''); ?>>News Banner</option>
                          <option value="tagSection" <?php echo e($section['function_ret'] == 'tagSection' ? 'selected' : ''); ?>>Tag Section</option>
                      </select>
                    </div>
                    <div class="mb-4" id="secondarySelect" style="display:none;">
                      ...
                      <select class="form-select" name="image_type" id="sectiontype">
                          ...
                          <option value="<?php echo e($tag->name); ?>" <?php echo e($section->image_type == $tag->name ? 'selected' : ''); ?>><?php echo e($tag->name); ?></option>
                      ...
                      <div class="mb-4">
                          ...
                          <textarea class="form-control" name="description" id="summernote" cols="43" rows="5" class="textarea" tabindex="5" onkeydown="limitText(this.form.short_desc,this.form.countdown1,5000);"
                            onkeyup="limitText(this.form.product_desc,this.form.countdown1,5000);"><?php echo e($section['description']); ?></textarea>
                      </div>
                  </div>
                </div>
              ...
              <div class="card w-100">
                  <div class="card-body p-5">
                    ...
                    <div class="mb-4">
                      ...
                      <input type="disabled" class="form-control" data-auto-close="true" data-language="en" value="<?php echo e(date('d-M-Y', strtotime($section['created_at']))); ?>" />
                    </div>
                    <div class="mb-4">
                      <label for="form-product/seo-title" class="form-label" >Updated date</label > 
                      <input type="disabled" class="form-control" data-auto-close="true" data-language="en" value="<?php echo e(date('d-M-Y', strtotime($section['updated_at']))); ?>" /><label class="form-check mb-0" >
                    </div>
                  </div>
...
<?php $__currentLoopData = $images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
<form action="<?php echo e(route('section.imageupdate', $image['id'] )); ?>" method="post" enctype="multipart/form-data" >
  <?php echo csrf_field(); ?>
  <?php echo method_field('PUT'); ?>
<div class="offcanvas offcanvas-end offcanvas-sa-card" tabindex="-1" id="fileManagerDetails<?php echo e($image['id']); ?>" aria-labelledby="fileManagerDetailsLabel">
  ...
  <div class="offcanvas-body" data-simplebar="">
      <div class="border p-4 d-flex justify-content-center mb-4">
          <div class="max-w-20x">
              <img id="image-preview" src="<?php echo e(url('wx.images/contents/articles/'.$image['image'])); ?>" class="w-100 h-auto" width="320" height="320" alt=""/>
          </div>
      </div>
      <div class="mb-4">
      ...
      <div class="mb-4">
        ...
        <input type="text" name="link" value="<?php echo e($image['link']); ?>" class="form-control"/>
      </div>
      <div class="mb-4">
      ...
      <div class="hstack gap-3"><button type="submit" class="btn btn-primary flex-grow-1">Update</button><a href="<?php echo e(route('section.imgdel', $image['id'] )); ?>" class="btn btn-secondary flex-grow-1">Delete</a></div>
  </div>
</div>
</form>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('wbxadmin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/luluconnect/resources/views/wbxadmin/contents/sectionedit.blade.php ENDPATH**/ ?>