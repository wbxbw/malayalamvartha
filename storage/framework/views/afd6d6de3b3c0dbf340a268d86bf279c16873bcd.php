...
<div id="top" class="sa-app__body">
  <div class="mx-sm-2 px-2 px-sm-3 px-xxl-4 pb-6">
    <div class="container">
      ...
      <form action="<?php echo e(route('blogs.update', $content['id'])); ?>" method="post" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12">
                            <div class="mb-4">
                                ...
                                <input type="text" placeholder="Blog Name" class="form-control" id="titleInput" name="name" value="<?php echo e($content['name']); ?>" />
                              </div>
                        </div>
                        <div class="col-lg-12 col-md-12">
                            <div class="mb-4">
                    ...
                    <table class="sa-table" id="myTables">
                        ...
                        <?php $__currentLoopData = $images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <tr>
                              <td>
                                <div class="sa-symbol sa-symbol--shape--rounded sa-symbol--size--lg">
                                  <a data-bs-toggle="offcanvas" href="#fileManagerDetails<?php echo e($image['id']); ?>" ><img src="<?php echo e(url('wx.images/blogs/articles/'.$image['image'])); ?>" width="40" height="40" alt=""></a>
                                </div>
                              </td>
                              <td>
...
<?php $__currentLoopData = $images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
<form action="<?php echo e(route('blog.imageupdate', $image['id'] )); ?>" method="post" enctype="multipart/form-data" >
  <?php echo csrf_field(); ?>
  <?php echo method_field('PUT'); ?>
<div class="offcanvas offcanvas-end offcanvas-sa-card" tabindex="-1" id="fileManagerDetails<?php echo e($image['id']); ?>" aria-labelledby="fileManagerDetailsLabel">
  ...
  <div class="offcanvas-body" data-simplebar="">
      <div class="border p-4 d-flex justify-content-center mb-4">
        <div class="max-w-20x"><img src="<?php echo e(url('wx.images/blogs/articles/'.$image['image'])); ?>" class="w-100 h-auto" width="320" height="320" alt=""/></div>
      </div>
      <div class="mb-4">
      ...
      <div class="hstack gap-3"><button type="submit" class="btn btn-primary flex-grow-1">Update</button><a href="<?php echo e(route('blog.imgdel', $image['id'] )); ?>" class="btn btn-secondary flex-grow-1">Delete</a></div>
  </div>
</div>
</form>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('wbxadmin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/luluconnect/resources/views/wbxadmin/blogs/edit.blade.php ENDPATH**/ ?>