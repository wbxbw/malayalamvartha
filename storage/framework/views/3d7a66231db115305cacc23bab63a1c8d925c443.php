  ...
  <div class="mx-sm-2 px-2 px-sm-3 px-xxl-4 pb-6">
    <div class="container">
      ...
      <div class="card">
        ...
        <div class="mb-5">
            <h2 class="mb-0 fs-exact-18"><a href="<?php echo e(route('categories.specifications',Crypt::encrypt($category['id']))); ?>">Specifications /</a> <?php echo e($specifications['name']); ?> </h2>
        </div>
          <input
            type="text"
        ...
        <table class="sa-datatables-init" data-sa-search-input="#table-search" >
          ...
          <?php $__currentLoopData = $specvalues; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $specvalue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
              ...
              <td>
                <a href="<?php echo e(route('categories.editspecvalue',Crypt::encrypt($specvalue['id']))); ?>" class="text-reset"><?php echo e($specvalue['name']); ?></a>
              </td>
              <td>
              ...
              <td>
                <div class="dropdown">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="category-context-menu-0" >
                    <li><a class="dropdown-item" href="<?php echo e(route('categories.editspecvalue',Crypt::encrypt($specvalue['id']))); ?>">Edit</a></li>
                    <!-- <li>
...
<?php echo $__env->make('wbxadmin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/luluconnect/resources/views/wbxadmin/categories/specvalues.blade.php ENDPATH**/ ?>