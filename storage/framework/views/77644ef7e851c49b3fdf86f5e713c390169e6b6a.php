  ...
  <div class="mx-sm-2 px-2 px-sm-3 px-xxl-4 pb-6">
    <div class="container">
      <div class="py-5">
        ...
        <div class="col">
          ...
          <!-- <div class="col-auto d-flex">
            <a href="<?php echo e(route('categories.create',['parent' => Crypt::encrypt($parentDetails->id)])); ?>" class="btn btn-primary"
              >New category</a
            >
          </div> -->
        </div>
      ...
      <div class="card">
        <div class="p-4">
        <div class="mb-5">
            <h2 class="mb-0 fs-exact-18"><?php echo e($breadcrumbs); ?> /</h2>
        </div>
          <input
            type="text"
        ...
        <table class="sa-datatables-init" data-sa-search-input="#table-search" >
          ...
          <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
              ...
              <td>
                <a href="<?php echo e(route('guides.edit',Crypt::encrypt($category['id']))); ?>" class="text-reset"><?php echo e($category['name']); ?></a>
              </td>
              <td>
                <?php if($category['bg_status'] == 'N'): ?>
                <div class="badge badge-sa-danger">Disabled</div>
                <?php endif; ?>
                <?php if($category['bg_status'] == 'Y'): ?>
                 <div class="badge badge-sa-success">Active</div>
                <?php endif; ?>
              </td>
              <td>
                <?php if($category['status'] == 'N'): ?>
                <div class="badge badge-sa-danger">Disabled</div>
                <?php endif; ?>
              ...
              <div class="notification-box">
                <a href="<?php echo e(route('guides.subindex',Crypt::encrypt($category['id']))); ?>">
              ...
              <td>
              <div class="notification-box">
                <a href="<?php echo e(route('guides.specifications',Crypt::encrypt($category['id']))); ?>">
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="black" class="bi bi-card-text" viewBox="0 0 16 16">
                    <path d="M14.5 3a.5.5 0 0 1 .5.5v9a.5.5 0 0 1-.5.5h-13a.5.5 0 0 1-.5-.5v-9a.5.5 0 0 1 .5-.5h13zm-13-1A1.5 1.5 0 0 0 0 3.5v9A1.5 1.5 0 0 0 1.5 14h13a1.5 1.5 0 0 0 1.5-1.5v-9A1.5 1.5 0 0 0 14.5 2h-13z"/>
                    <path d="M3 5.5a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5zM3 8a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9A.5.5 0 0 1 3 8zm0 2.5a.5.5 0 0 1 .5-.5h6a.5.5 0 0 1 0 1h-6a.5.5 0 0 1-.5-.5z"/>
                  </svg>
                  <span class="notification-counter"><?php echo e($category->cat_specifications_count); ?></span> <!-- Change the number to your notification count -->
                </a>
              </div>
              </td>
              <td>
              ...
              <td>
                <div class="dropdown">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="category-context-menu-0" >
                    <li><a class="dropdown-item" href="<?php echo e(route('guides.edit',Crypt::encrypt($category['id']))); ?>">Edit</a></li>
                  </ul>
                </div>
              </td>
            </tr>
...
<?php echo $__env->make('wbxadmin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/luluconnect/resources/views/wbxadmin/guides/sub.blade.php ENDPATH**/ ?>