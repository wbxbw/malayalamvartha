        ...
        <table class="sa-datatables-init" data-sa-search-input="#table-search" >
          ...
          <?php $__currentLoopData = $specifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $specification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
              ...
              <td>
                <a href="#" class="text-reset"><?php echo e($specification['name']); ?></a>
              </td>
              <td>
              <div class="notification-box">
                <a href="<?php echo e(route('guides.specvalues',Crypt::encrypt($specification['id']))); ?>">
...
<?php echo $__env->make('wbxadmin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/luluconnect/resources/views/wbxadmin/guides/spec.blade.php ENDPATH**/ ?>